...
const socialLinks: socialLinks[] = [
  ...
  },
  {
    ...
    link: 'https://www.instagram.com/@CloudmavinCC',
    width: 14
  },
  {
    imgSrc: '/assets/footer/twitter.svg',
    link: 'https://www.twitter.com/cloud_mavinCC',
    width: 14
  }
];
    ...
    <div className="mx-auto max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
        ...
        <div className="sm:col-span-6 lg:col-span-5">
          ...
          <h3 className="text-md font-medium text-gunmetalgray lh-160 mt-5 mb-4 lg:mb-16 flex flex-col">
            Do you want to begin your journey in cybersecurity?
            <Link
              href="https://forms.gle/koeLnzY8jcHuNTy29"
      ...
      <div className="py-10 md:flex items-center justify-between border-t border-t-gray-blue">
        <h4 className="text-dark-red opacity-75 text-sm text-center md:text-start font-normal">
          &copy;{currentYear} Cloud Mavin. All rights reserved
        </h4>
